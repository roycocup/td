...
var createRoad = function(){
  ...
  var x = Math.round(game.rnd.between(0, Dim.game.w)/Dim.cube.w);
  var y = 0;
  while(y <= Dim.game.h){
...
var max_hor_cubes = Dim.game.w/Dim.cube.w;
var max_vert_cubes;
...
var createCubes = function(){
  ...
  for (var i = 0; i < total_cubes-1; i++) {
    ...
    var id = [depth, x/Dim.cube.w];
    var c = new Cube(x,y,id);
    cubes.push(c);
  }
  max_vert_cubes = depth;
}
